...
-- The following table is hosed because some additional tables are followed by a group indicator and others by a rotation...
local SymbolNames = {
{ '!', "BB", "OB", tAmenity, "Police Stn", tSpecial, "Emergency", nil, nil, 90},
{ '"', "BC", "OC", tUndefined, "No Symbol p", tUndefined, "No Symbol a"},
{ '#', "BD", "OD", tInfra, "Digi", tInfra, "No. Digi" },
{ '$', "BE", "OE", tMobile, "Phone", tAmenity, "Bank", OverATM, -30 },
{ '%', "BF", "OF", tInfra, "DX Cluster", tAmenity, "Power Plant", OverPowerPlant },
{ '&', "BG", "OG", tInfra, "HF Gateway", tInfra, "No. Gateway", OverGateway },
{ '\'',"BH", "OH", tFlying, "Plane Sm", tSpecial, "Crash site", OverIncidentSites, 90, 45 },
{ '(', "BI", "OI", tMobile, "Mob Sat Stn", tWeather, "Cloudy", nil, nil, 90},
...
{ ',', "BM", "OM", tHuman, "Boy Scout", tHuman, "Girl Scout", nil, 90, -90},
{ '-', "BN", "ON", tFixed, "Home", tFixed, "Home (HF)", OverHome, 90, 90 },
...
{ '9', "P9", "A9", tMarker, "Circle (9)", tAmenity, "Petrol Stn", nil, nil, 90},

{ ':', "MR", "NR", tSpecial, "Fire", tWeather, "Hail", nil, nil, 90},
{ ';', "MS", "NS", tAmenity, "Campground", tAmenity, "Park", OverPortable, nil, 90 },
{ '<', "MT", "NT", tMobile, "Motorcycle", tWeather, "Advisory" },	-- , &OverAdvisory
{ '=', "MU", "NU", tMobile, "Rail Eng.", tSpecial, "APRStt (DTMF)", OverDTMF },
{ '>', "MV", "NV", tMobile, "Car", tMobile, "No. Car", OverCar, nil, 90 },
{ '?', "MW", "NW", tFixed, "File svr", tSpecial, "Info Kiosk", nil, nil, -90},
...
{ 'G', "PG", "AG", tSpecial, "Grid Squ.", tWeather, "Snow Shwr", nil, nil, -90},
{ 'H', "PH", "AH", tAmenity, "Hotel", tWeather, "Haze/Hazard", OverHazards },
{ 'I', "PI", "AI", tInfra, "Tcp/ip", tWeather, "Rain Shwr", nil, nil, -90},
{ 'J', "PJ", "AJ", tUndefined, "No Symbol J", tWeather, "Lightning", nil, nil, -90},
{ 'K', "PK", "AK", tAmenity, "School", tBrand, "Kenwood", nil, 90},
{ 'L', "PL", "AL", tInfra, "Usr Log-ON", tFixed, "Lighthouse", nil, nil, 90},
{ 'M', "PM", "AM", tBrand, "MacAPRS", tFixed, "MARS" },	-- , &OverMARS
{ 'N', "PN", "AN", tInfra, "NTS Stn", tInfra, "Nav Buoy", nil, nil, 90},
{ 'O', "PO", "AO", tFlying, "Balloon", tFlying, "Rocket", nil, 90, 90},
{ 'P', "PP", "AP", tMobile, "Police", tMarker, "Parking  "},
{ 'Q', "PQ", "AQ", tMarker, "TBD/Bullseye", tWeather, "Quake"},
{ 'R', "PR", "AR", tMobile, "Rec Veh'le", tAmenity, "Restaurant", OverRestaurant, tBrand },	-- ????? OverRestaurant should be tBrand?
{ 'S', "PS", "AS", tFlying, "Shuttle", tInfra, "Sat/Pacsat", nil, 90, 90},
{ 'T', "PT", "AT", tInfra, "SSTV", tWeather, "T'storm", nil, nil, -90},
...
{ '^', "HV", "DV", tFlying, "Plane Lrge", tFlying, "No. Plane", nil, 90, 90},
{ '_', "HW", "DW", tWeather, "WX Service", tWeather, "No. WX Site" },
{ '`', "HX", "DX", tFixed, "Dish Ant.", tWeather, "Rain", nil, -135},

{ 'a', "LA", "SA", tMobile, "Ambulance", tMarker, "No. Diamond", OverARRL, tFixed },
{ 'b', "LB", "SB", tHuman, "Bike", tWeather, "Dust blwng"},
{ 'c', "LC", "SC", tMarker, "ICP", tFixed, "No CivDef", OverCivil, nil, 90 },
{ 'd', "LD", "SD", tFixed, "Fire Station", tInfra, "DX Spot", nil, 90},
{ 'e', "LE", "SE", tHuman, "Horse", tWeather, "Sleet"},
{ 'f', "LF", "SF", tMobile, "Fire Truck", tWeather, "Funnel Cld", nil, nil, -90},
{ 'g', "LG", "SG", tFlying, "Glider", tWeather, "Gale"},
{ 'h', "LH", "SH", tFixed, "Hospital", tFixed, "(HAM) Store", OverStore, tBrand },	-- OverStore should be tBrand
{ 'i', "LI", "SI", tFixed, "Island", tMarker, "No. Blk Box", nil, 90},
...
{ 'n', "LN", "SN", tInfra, "Node", tMarker, "No. Triang", nil, nil, 90},
{ 'o', "LO", "SO", tFixed, "EOC", tMarker, "Circle sm", nil, 90},
{ 'p', "LP", "SP", tHuman, "Rover", tWeather, "Part Cloud"},
{ 'q', "LQ", "SQ", tSpecial, "Grid squ.", tUndefined, "No Symbol q"},
{ 'r', "LR", "SR", tInfra, "Antenna", tAmenity, "Restrooms", nil, 90},
{ 's', "LS", "SS", tFloat, "Power Boat", tFloat, "No. Boat" },
{ 't', "LT", "ST", tFixed, "Truck Stop", tWeather, "Tornado", nil, nil, -90},
...
{ 'y', "LY", "SY", tInfra, "Yagi", tWeather, "Sky Warn", nil, 90, -90},
{ 'z', "LZ", "SZ", tFixed, "Shelter", tFixed, "No Shelter", nil, 90, 90},
	...
	elseif t[4] == nil or t[6] == nil then
		...
		if type(t[8]) == 'table' then
			for i,e in ipairs(t[8]) do
				addSymbolToGroup(e[3] or t[6], e[1]..t[1], e[2])	-- Need to migrate groups to extended symbols
