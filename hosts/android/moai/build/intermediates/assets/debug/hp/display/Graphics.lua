...
function M:setSize(width, height)
	...
	--print(string.format("Graphics:setPos(%d,%d)", left, top))
...
--print(string.format("Graphics:command:drawLine of %d points width %d from %s", #args[1], self.penWidth, where))
--		for i=1,#args[1],2 do
--			print(string.format(",%d,%f,%f", i, args[1][i], args[1][i+1]))
--		end
	end
	local command = function(self)
